...
var result4 = arr4.splice(1, 3, "AT弄潮儿", "vae");
...
```javascript
    const arr1 = [
        { name: 'AT弄潮儿', age: '28' }, { name: '许嵩', age: '32' }
    ];
...
```
    arr1:[{"name":"AT弄潮儿","age":"28"},{"name":"许嵩","age":"32"}]
